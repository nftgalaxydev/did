mod tests {
    ...
    use gid::registrar::{ExecuteMsg as RegistrarExecuteMsg, Extension};
    use gid::registry::ExecuteMsg as RegistryExecuteMsg;
    use gid::resolver::ExecuteMsg as ResolverExecuteMsg;
    ...
    fn test_register() {
        ...
        let secret = String::from("gid_secret");
